...
public class TextToSpeech
  ...
  public void onInit(int status) {
    try {
      ...
      Log.d(
        TAG,
        "Caught exception while listening to OnInitListener.OnInit(): " +
  ...
  public void load() {
    ...
    try {
      ...
      Log.d(
        TAG,
        "Caught exception on TextToSpeech load(): " + ex.getLocalizedMessage()
      );
    }
  }
  ...
  public void speak(final PluginCall call) {
    try {
      ...
      if (
        !call.hasOption("volume") || !isStringValid(call.getString("volume"))
      ) {
        volume = 1.0;
      } else {
      ...
      Log.d(
        TAG,
        "Exception caught while handling speak(): " + ex.getLocalizedMessage()
      );
  ...
  public void stop(PluginCall call) {
    try {
      ...
      Log.d(
        TAG,
        "Exception caught while handling stop(): " + ex.getLocalizedMessage()
      );
      call.error(ex.getLocalizedMessage());
    }
  }
  ...
  public void getSupportedLanguages(PluginCall call) {
    try {
      ...
      Log.d(
        TAG,
        "Exception caught while handling checkLanguage(): " +
        ex.getLocalizedMessage()
      );
      call.error(ex.getLocalizedMessage());
    }
